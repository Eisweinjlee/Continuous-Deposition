...
% If the device is recognized successfully, we can run
...
% TODO: make a sentence to ask whether user want to continue or not!!

%% 4. Normalize the data to what we want
...
load('data\%s-mt.mat', name) % TODO: the name variable has been cleared
depthImage = picMt(:,:,1);
...
PY2 = 286; %263
%zplane start 560
PX = [PX1:PX2];   %?@‰æ‘œ‚ÌŽR‚Ì”ÍˆÍ‚ðŽw’è
PY = [PY1:PY2];
...
dep3 = dep;
% save('C:\Users\banana\Desktop\EX_WORK\EXPERIMENT\MPC_fixedhorizon_experiment\data\dep3.mat','dep3')
